...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Titano lottery
     */
    ...
    /**
     * @notice Set the address for the TitanoLottery
     * @param _titanoLottery: address of the Titano lottery
     */
    function setLotteryAddress(address _titanoLottery) external onlyOwner {
